      ...
      >
        <header style="text-align:center; margin-bottom:3rem;">
          <span
            ...
            >groupNavigateSection · brutalism · 102054</span
          >
          <h1 style="font-size:2.25rem; font-weight:700; color:#000; text-transform:uppercase; margin-bottom:0.5rem;">Navigate Section</h1>
        </header>
